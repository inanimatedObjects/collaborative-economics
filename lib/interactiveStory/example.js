...
// bar charts
  ...
  d3.csv("story.csv", convertTextToNumbers, function(error1, dataStory) {
    ...
    .selectAll("stop")
      .data([
        ...
        // {offset: "50%", color: siuColours.orange30},
      ])
    .enter().append("stop")
  ...
  for (storyMaxAge; storyMaxAge < maxAge; storyMaxAge++) {
    ...
    .enter()
      ...
      .style("fill", function(d) { return d.originalculum > 0 ? siuColours.teal30 : siuColours.orange30 ; })
    ...
    .enter()
      ...
      .attr("y", function(d) { return yBarChart(1); })
      .attr("height",  heightBarChart)
      .style("fill", function(d) { return d.alternativeculum > 0 ? siuColours.teal30 : siuColours.orange30 ; })
      .style("fill-opacity", 0.7)
      .style("stroke-opacity", 0.7);
  ...
  function changeCharts() {
    ...
    storyBarChart.selectAll("rect")
      ...
      nextParaColour =  siuColours.greyLight;
  ...
  function updateBarChart(data, currentAge, chartClass) {
    ...
    currentAgeData = data.filter(function (d) {return d.age == currentAge; } );
      ...
      if (oldValue < 0 && currentAgeData[0][culumValue] > 0){
        ...
        .style("fill", function(d) { return d[culumValue] > 0 ? siuColours.teal30 : siuColours.orange30 ; });
